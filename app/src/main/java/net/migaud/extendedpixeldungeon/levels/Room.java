...
import net.migaud.extendedpixeldungeon.PixelDungeon;
import net.migaud.extendedpixeldungeon.levels.painters.*;
import net.migaud.extendedpixeldungeon.utils.Bundlable;
import net.migaud.extendedpixeldungeon.utils.Bundle;
import net.migaud.extendedpixeldungeon.utils.Graph;
import net.migaud.extendedpixeldungeon.utils.Point;
import net.migaud.extendedpixeldungeon.utils.Random;
import net.migaud.extendedpixeldungeon.utils.Rect;
import net.migaud.extendedpixeldungeon.levels.painters.AltarPainter;
import net.migaud.extendedpixeldungeon.levels.painters.ArmoryPainter;
import net.migaud.extendedpixeldungeon.levels.painters.BlacksmithPainter;
import net.migaud.extendedpixeldungeon.levels.painters.BossExitPainter;
import net.migaud.extendedpixeldungeon.levels.painters.CryptPainter;
import net.migaud.extendedpixeldungeon.levels.painters.EntrancePainter;
import net.migaud.extendedpixeldungeon.levels.painters.ExitPainter;
import net.migaud.extendedpixeldungeon.levels.painters.GardenPainter;
import net.migaud.extendedpixeldungeon.levels.painters.LaboratoryPainter;
import net.migaud.extendedpixeldungeon.levels.painters.LibraryPainter;
import net.migaud.extendedpixeldungeon.levels.painters.MagicWellPainter;
import net.migaud.extendedpixeldungeon.levels.painters.Painter;
import net.migaud.extendedpixeldungeon.levels.painters.PassagePainter;
import net.migaud.extendedpixeldungeon.levels.painters.PitPainter;
import net.migaud.extendedpixeldungeon.levels.painters.PoolPainter;
import net.migaud.extendedpixeldungeon.levels.painters.RatKingPainter;
import net.migaud.extendedpixeldungeon.levels.painters.ShopPainter;
import net.migaud.extendedpixeldungeon.levels.painters.StandardPainter;
import net.migaud.extendedpixeldungeon.levels.painters.StatuePainter;
import net.migaud.extendedpixeldungeon.levels.painters.StoragePainter;
import net.migaud.extendedpixeldungeon.levels.painters.TrapsPainter;
import net.migaud.extendedpixeldungeon.levels.painters.TreasuryPainter;
import net.migaud.extendedpixeldungeon.levels.painters.TunnelPainter;
import net.migaud.extendedpixeldungeon.levels.painters.VaultPainter;
import net.migaud.extendedpixeldungeon.levels.painters.WeakFloorPainter;
