...
package net.migaud.extendedpixeldungeon.glscripts;

import java.util.HashMap;

import net.migaud.extendedpixeldungeon.glwrap.Program;
import net.migaud.extendedpixeldungeon.glwrap.Shader;
