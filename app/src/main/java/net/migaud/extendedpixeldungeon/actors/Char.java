 ...
 */
package net.migaud.extendedpixeldungeon.actors;
...
import net.migaud.extendedpixeldungeon.actors.buffs.Speed;
import net.migaud.extendedpixeldungeon.actors.buffs.Levitation;
...
import net.migaud.extendedpixeldungeon.actors.buffs.Slow;
...
import net.migaud.extendedpixeldungeon.effects.particles.PoisonParticle;
...
public abstract class Char extends Actor {
	...
	public void move( int step ) {
		...
		if (Level.adjacent( step, pos ) && buff( Vertigo.class ) != null) {
			...
			if (!(Level.passable[step] || Level.avoid[step]) || findChar( step ) != null) {
				return;
			}
		}
