...
import net.migaud.extendedpixeldungeon.Journal.Feature;
...
import net.migaud.extendedpixeldungeon.actors.buffs.FlavourBuff;
...
import net.migaud.extendedpixeldungeon.effects.Wound;
import net.migaud.extendedpixeldungeon.effects.particles.SacrificialParticle;
import net.migaud.extendedpixeldungeon.items.scrolls.ScrollOfWipeOut;
