...
import net.migaud.extendedpixeldungeon.Badges.Badge;
...
import net.migaud.extendedpixeldungeon.items.TomeOfMastery;
...
import net.migaud.extendedpixeldungeon.sprites.TenguSprite;
