 ...
 */
package net.migaud.extendedpixeldungeon.items.weapon.enchantments;
...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc(Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, net.migaud.extendedpixeldungeon.actors.buffs.Poison.class ).
				set( net.migaud.extendedpixeldungeon.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );
