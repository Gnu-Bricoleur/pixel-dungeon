...
import net.migaud.extendedpixeldungeon.items.EquipableItem;
import net.migaud.extendedpixeldungeon.items.Item;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.*;
...
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Affection;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.AntiEntropy;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.AutoRepair;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Bounce;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Displacement;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Entanglement;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Metabolism;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Multiplicity;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Potential;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Stench;
import net.migaud.extendedpixeldungeon.items.armor.glyphs.Viscosity;
