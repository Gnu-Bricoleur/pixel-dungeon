 ...
 */
package net.migaud.extendedpixeldungeon.items.weapon;
...
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.*;
...
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Fire;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Horror;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Instability;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Leech;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Luck;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Paralysis;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Poison;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Shock;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Slow;
import net.migaud.extendedpixeldungeon.items.weapon.enchantments.Tempering;
